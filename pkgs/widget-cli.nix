{ stdenvNoCC, pyEnv, makeWrapper, wrapGAppsHook4, gtk4, gobject-introspection
, fuzzel, libnotify, jq, xdg-utils, wl-clipboard }:
...
# PangoCairo, Graphene, etc. all come along automatically). We let it
# auto-wrap during fixupPhase instead of doing the makeWrapper dance
# ourselves so we don't have to maintain the typelib list by hand.
